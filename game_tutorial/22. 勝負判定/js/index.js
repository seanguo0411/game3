...
const player = new Player(32000, 32000, 64, 24, 60, 0, 0, 100, 100, {
  ...
  idle_down: new Anima(url, 1, general_speed),
  idle_up: new Anima(url, 1, general_speed),
  idle_left: new Anima(url, 1, general_speed),
  idle_right: new Anima(url, 1, general_speed),
  walk_down: new Anima(url, 1, general_speed),
  walk_up: new Anima(url, 1, general_speed),
  walk_left: new Anima(url, 1, general_speed),
  walk_right: new Anima(url, 1, general_speed),
});
